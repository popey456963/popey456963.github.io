var links = [{label: 'Arrows', bg: '#c0392b', href: 'Useful/Arrows'}, 
             {label: 'Orbital', bg: '#16a085', href: 'Useful/Orbital'}, 
             {label: 'To Do List', bg: '#8e44ad', href: 'Useful/ToDoList'}, 
			 {label: 'Distance', bg: '#27ae60', href: 'Useful/Distance'},
			 {label: 'Clock', bg: '#f39c12', href: 'Useful/Clock'},	
