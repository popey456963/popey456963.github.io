var links = [{label: 'Flower', bg: '#c0392b', href: 'Pretty/Flower'}, 
             {label: 'Ghost', bg: '#16a085', href: 'Pretty/Ghost'}, 
             {label: 'Zombie', bg: '#8e44ad', href: 'Pretty/Zombie'},
			 {label: 'Loading', bg: '#27ae60', href: 'Pretty/Loading'},
			 {label: 'Game Loading', bg: '#f39c12', href: 'Pretty/GameLoading'},	
             {label: 'Background', bg: '#2980b9', href: 'Pretty/Background'},		
